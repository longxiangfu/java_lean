     ...
     * 没有自适应的方法的调用将报错
     */
    public class GoodsOrder$Adaptive implements com.lxf.jdk8.foundation.spi.dubbo.GoodsOrder {
        ...
        public java.lang.String payWay(org.apache.dubbo.common.URL arg0)  {
            ...
            com.lxf.jdk8.foundation.spi.dubbo.GoodsOrder extension = (com.lxf.jdk8.foundation.spi.dubbo.GoodsOrder)ExtensionLoader.getExtensionLoader(com.lxf.jdk8.foundation.spi.dubbo.GoodsOrder.class).getExtension(extName);
