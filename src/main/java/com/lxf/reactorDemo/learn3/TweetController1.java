...
//    @ApiOperation("通过id查找")
//    @GetMapping("/tweet/{id}")
//    public Mono<Tweet> getTweetById(@ApiParam(name = "id",value="推特id",required = true) @PathVariable String id) {
...
//    @ApiOperation("通过id更新")
//    @PutMapping("/tweet/{id}")
//    public Mono<Tweet> updateTweet(@ApiParam(name = "id", value = "推特id") @PathVariable(value = "id") String tweetId,
